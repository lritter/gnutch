 ...
 */
public class PipeReducer extends PipeMapRed implements Reducer<WritableComparable,Writable,WritableComparable,Writable> {
  ...
  boolean getDoPipe() {
    ...
    public void reduce(WritableComparable key, Iterator<Writable> values, OutputCollector<WritableComparable,Writable> output,
