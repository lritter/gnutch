...
public class StreamJob {
  ...
  protected void setJobConf() throws IOException {
    ...
    jobConf_.set("mapred.output.compress","false");
    ...
    if (inReaderSpec_ == null && inputFormatSpec_ == null) {
      ...
      } else if (inputFormatSpec_.equals(SequenceFileAsBinaryInputFormat.class
          .getName())
          || inputFormatSpec_.equals(SequenceFileAsBinaryInputFormat.class.getSimpleName())) {
	fmt = SequenceFileAsBinaryInputFormat.class;
      } else if (inputFormatSpec_.equals(JSONPipeMapper.ContentInputFormat.class.getName())
	  || inputFormatSpec_.equals(JSONPipeMapper.ContentInputFormat.class.getSimpleName())) {
	fmt = JSONPipeMapper.ContentInputFormat.class;
      } else {
    ...
    if (mapCmd_ != null) {
      ...
      if (c != null) {
        ...
        jobConf_.setMapperClass(JSONPipeMapper.class);
